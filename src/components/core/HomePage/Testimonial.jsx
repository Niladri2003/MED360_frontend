      ...
      <div class="container mx-auto my-24 md:px-6">
        <section class="mb-32 text-center">
          ...
          <div class="grid gap-x-6 md:grid-cols-3 lg:gap-x-12">
            <div class="mb-12 border-[1px] p-4 shadow-md md:mb-0">
              ...
              <h5 class="mb-2 text-lg font-bold">Tuhin Manna</h5>
            ...
            <div class="mb-12 border-[1px] p-4 shadow-md md:mb-0">
              ...
              <h5 class="mb-2 text-lg font-bold">Satwick Bera</h5>
              {/* <h6 class="mb-4 font-medium text-primary dark:text-primary-400">
                                Graphic Designer
                            </h6> */}
              <p class="mb-4 text-sm">
            ...
            <div class="mb-0 border-[1px] p-4 shadow-md">
              <div class="mb-6 flex justify-center">
                <img
              ...
              <h5 class="mb-2 text-lg font-bold">Manas Das</h5>
              {/* <h6 class="mb-4 font-medium text-primary dark:text-primary-400">
